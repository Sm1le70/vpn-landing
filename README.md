...
Откройте http://localhost:3000. В демо-режиме Platega, Remnawave и Resend заменены заглушками: настоящих платежей нет, панель не нужна, `.env` не требуется.
...
scripts/demo.js       демо-режим с заглушками Platega, Remnawave и Resend
